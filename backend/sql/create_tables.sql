...
-- ------------------------------------------------------------
-- 1. user_profiles
-- Criado automaticamente via trigger do Supabase Auth (veja abaixo)
-- ou inserido manualmente após auth.admin.createUser
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 4. cultures
-- Se já existir, adiciona as novas colunas (idempotente)
-- ------------------------------------------------------------
...
-- Caso a tabela já exista, adiciona colunas novas sem erro
...
-- Caso a tabela já exista, adiciona colunas novas
...
-- ============================================================
-- SUPABASE STORAGE — criar bucket (rodar separado ou via API)
-- ============================================================
